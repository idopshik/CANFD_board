             ...
             */
                ...
                if (arr_with_calculations[0] != arr_with_calculations[1]) {
                    ...
                    TIM3->ARR = arr_with_calculations[3];
                        ...
                        HAL_GPIO_TogglePin(PreLastPin_GPIO_Port, PreLastPin_Pin);
                }
            }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PreLastPin_GPIO_Port, PreLastPin_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : PreLastPin_Pin */
  GPIO_InitStruct.Pin = PreLastPin_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PreLastPin_GPIO_Port, &GPIO_InitStruct);
