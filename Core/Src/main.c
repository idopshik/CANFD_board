    ...
    if (vRLrpm == 0) {
        ...
        if (vRLrpm > whl_arr[numRL]->prev_speed) {
             ...
             */
                ...
                if (arr_with_calculations[0] != arr_with_calculations[1]) {
                    whl_arr[numRL]->psc_change_flag = 1;
                    g_psc_change_flag = 1;
...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOA, LED_TX1_Pin | LED_RX1_Pin | LED_TX2_Pin | LED_RX2_Pin | LED_TX3_Pin, GPIO_PIN_SET);
    ...
    /*Configure GPIO pins : LED_TX1_Pin LED_RX1_Pin LED_TX2_Pin LED_RX2_Pin
                             LED_TX3_Pin */
    GPIO_InitStruct.Pin = LED_TX1_Pin | LED_RX1_Pin | LED_TX2_Pin | LED_RX2_Pin | LED_TX3_Pin;
